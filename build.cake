...
var xunit = "test/Nancy.Bootstrappers.Windsor.Tests/bin/" + configuration + "/net452/unix-x64/dotnet-test-xunit.exe";
...
Task("Package")
    ...
    {
        var package =
            outputPackages + File("Nancy.Bootstrappers.Windsor-Latest.zip");
    ...
    .Does(() =>
    {
        ...
        else
        {
            ...
            var settings = new ProcessSettings {
                Arguments = xunit + " " + "test/Nancy.Bootstrappers.Windsor.Tests/bin/"+configuration+"/net452/unix-x64/Nancy.Bootstrappers.Windsor.Tests.dll"
            };
            ...
            using(var process = StartAndReturnProcess("mono", settings))
            {
                ...
                {
                    throw new Exception("Nancy.Bootstrappers.Windsor.Tests failed.");
                }
            }
        }
    });
...
Task("Update-Version")
    ...
    .Does(() =>
    {
        ...
        UpdateProjectJsonVersion(version, "src/Nancy.Bootstrappers.Windsor/project.json");
    });
